"""
Django Paystack Wallet - Settlement API (COMPLETE VERSION)
Comprehensive API endpoints with OTP support, statistics, and query optimization

INCLUDES:
- OTP finalization endpoint
